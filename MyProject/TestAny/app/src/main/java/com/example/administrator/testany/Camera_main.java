...
import com.example.administrator.testany.camera.PlanarYUVLuminanceSource;
import com.example.administrator.testany.decoding.CaptureActivityHandler;

import com.example.administrator.testany.decoding.DecodeFormatManager;
import com.example.administrator.testany.decoding.DecodeHandler;
import com.example.administrator.testany.decoding.InactivityTimer;

import com.example.administrator.testany.view.ViewfinderResultPointCallback;
import com.example.administrator.testany.view.ViewfinderView;
...
public class Camera_main extends Activity implements Callback ,OnClickListener{
...
//        goPageURL(obj.getText());
        Toast toast_123 = Toast.makeText(this,"签到成功",Toast.LENGTH_LONG);
        toast_123.show();
    }
    ...
    private void goPageURL(String result){
        Toast toast = Toast.makeText(this, "��ɨ�裬���ڴ���...", Toast.LENGTH_LONG);
