...
import com.example.administrator.woocongress_modified.decoding.CaptureActivityHandler;
import com.example.administrator.woocongress_modified.decoding.InactivityTimer;
import com.example.administrator.woocongress_modified.view.ViewfinderView;
...
public class Camera_main extends Activity implements Callback ,OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getIntent();
        position = getIntent().getIntExtra("meetingnumber",position);
...
//        goPageURL(obj.getText());
        ...
        intent.putExtra("meetingnumber",position);
